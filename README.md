...
The ASF-LKUNet can be used for academic research only, please do not use them for commercial purposes. If you have any problem with the use of ASF-LKUNet, please contact: rfwang@xidian.edu.cn and mzhaoshan@163.com.

Please consider citing us if you find this work helpful:

Wang, Rongfang; Mu, zhaoshan; Wang, kai; Liu, Hui; Zhou, Zhiguo; Gou, Shuiping; Wang Jing; Jiao Licheng. (2023): ASF-LKUNet: Adjacent-Scale Fusion U-Net with Large-kernel for Medical Image Segmentation. TechRxiv. Preprint. https://doi.org/10.36227/techrxiv.22794728.v1
